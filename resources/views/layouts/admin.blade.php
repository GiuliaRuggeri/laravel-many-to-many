                ...
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark navbar-dark sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
							...
							<li class="nav-item">
                                <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.technolies.index' ? 'bg-secondary' : '' }}"
                                    href="{{ route('admin.technologies.index') }}">
                                    <i class="fa-solid fa-rectangle-list fa-lg fa-fw"></i> Technologies list
                                </a>
                            </li>
							<li class="nav-item">
                                <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.techologies.create' ? 'bg-secondary' : '' }}"
                                    href="{{ route('admin.technologies.create') }}">
                                    <i class="fa-solid fa-square-plus fa-lg fa-fw"></i> Create new technology
                                </a>
                            </li>
